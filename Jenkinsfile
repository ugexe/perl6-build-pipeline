                    ...
                    "linux" : {
                        node('linux') {
                            ...
                            dir('nqp') {
                                ...
                                sh 'make test'
                                step([$class: "TapPublisher", testResults: "$WORKSPACE/report/nqp/**/*.t", failIfNoResults: true, outputTapToConsole: true, showOnlyFailures: true, skipIfBuildNotOk: false, todoIsFailure: false, verbose: true])
                            ...
                            dir('rakudo') {
                                ...
                                sh 'make test'
                                step([$class: "TapPublisher", testResults: "$WORKSPACE/report/rakudo/**/*.t", failIfNoResults: true, outputTapToConsole: true, showOnlyFailures: true, skipIfBuildNotOk: false, todoIsFailure: false, verbose: true])
